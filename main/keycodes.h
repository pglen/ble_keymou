...
/* keycap on a standard US keyboard */

struct keycode {

    unsigned int position;                  // Where it is at physically
    unsigned int usb, set1, set2, set3;     // Scan codes
    char chx;                               // Character non shift
    char schx;                              // Character with shift
    char *name;                             // Label on key
};

struct keycode  keycodes[] = {
    { 1,    53,    0x29,    0x0e,    0x0e, '`', '~',    "`~" },
    { 2,    30,    0x02,    0x16,    0x16, '1', '!',    "1!" },
    { 3,    31,    0x03,    0x1e,    0x1e, '2', '@',    "2@" },
    { 4,    32,    0x04,    0x26,    0x26, '3', '#',    "3#" },
    { 5,    33,    0x05,    0x25,    0x25, '4', '$',    "4$" },
    { 6,    34,    0x06,    0x2e,    0x2e, '5', '%',    "5%" },
    { 7,    35,    0x07,    0x36,    0x36, '6', '^',    "6^" },
    { 8,    36,    0x08,    0x3d,    0x3d, '7', '&',    "7&" },
    { 9,    37,    0x09,    0x3e,    0x3e, '8', '*',    "8*" },
    { 10,   38,    0x0a,    0x46,    0x46, '9', '(',    "9(" },
    { 11,   39,    0x0b,    0x45,    0x45, '0', ')',    "0)" },
    { 12,   45,    0x0c,    0x4e,    0x4e, '-', '_',    "-_" },
    { 13,   46,    0x0d,    0x55,    0x55, '=', '+',    "=+" },
    { 15,   42,    0x0e,    0x66,    0x66, '\b', '\b',   " Backspace"},

    { 16,    43,    0x0f,    0x0d,    0x0d, ' ', ' ',    " Tab"},
    { 17,    20,    0x10,    0x15,    0x15, 'q', 'Q',    "qQ"},
    { 18,    26,    0x11,    0x1d,    0x1d, 'w', 'W',    "wW"},
    { 19,     8,    0x12,    0x24,    0x24, 'e', 'E',    "eE"},
    { 20,    21,    0x13,    0x2d,    0x2d, 'r', 'R',    "rR"},
    { 21,    23,    0x14,    0x2c,    0x2c, 't', 'T',    "tT"},
    { 22,    28,    0x15,    0x35,    0x35, 'y', 'Y',    "yY"},
    { 23,    24,    0x16,    0x3c,    0x3c, 'u', 'U',    "uU"},
    { 24,    12,    0x17,    0x43,    0x43, 'i', 'I',    "iI"},
    { 25,    18,    0x18,    0x44,    0x44, 'o', 'O',    "oO"},
    { 26,    19,    0x19,    0x4d,    0x4d, 'p', 'P',    "pP"},
    { 27,    47,    0x1a,    0x54,    0x54, '[', '{',    "[{"},
    { 28,    48,    0x1b,    0x5b,    0x5b, ']', '}',    "]}"},
    { 29,    49,    0x2b,    0x5d,    0x5c, '\\', '|',    "\\|"},

    { 30,    57,    0x3a,    0x58,    0x14, ' ', ' ',   " CapsLock"},
    { 31,    04,    0x1e,    0x1c,    0x1c, 'a', 'A',   "aA"},
    { 32,    22,    0x1f,    0x1b,    0x1b, 's', 'S',   "sS"},
    { 33,     7,    0x20,    0x23,    0x23, 'd', 'D',   "dD"},
    { 34,     9,    0x21,    0x2b,    0x2b, 'f', 'F',   "fF"},
    { 35,    10,    0x22,    0x34,    0x34, 'g', 'G',   "gG"},
    { 36,    11,    0x23,    0x33,    0x33, 'h', 'H',   "hH"},
    { 37,    13,    0x24,    0x3b,    0x3b, 'j', 'J',   "jJ"},
    { 38,    14,    0x25,    0x42,    0x42, 'k', 'K',   "kK"},
    { 39,    15,    0x26,    0x4b,    0x4b, 'l', 'L',   "lL"},
    ...
    { 46,     29,    0x2c,    0x1a,    0x1a, 'z', 'Z',   "zZ"},
    { 47,     27,    0x2d,    0x22,    0x22, 'x', 'X',   "xX"},
    { 48,      6,    0x2e,    0x21,    0x21, 'c', 'C',   "cC"},
    { 49,     25,    0x2f,    0x2a,    0x2a, 'v', 'V',   "vV"},
    { 50,      5,    0x30,    0x32,    0x32, 'b', 'B',   "bB"},
    { 51,     17,    0x31,    0x31,    0x31, 'n', 'N',   "nN"},
    { 52,     16,    0x32,    0x3a,    0x3a, 'm', 'M',   "mM"},
